...
import static beerstock.utils.JsonConvertionUtils.asJsonString;
...
public class BeerControllerTest {
    ...
    @Test
    void whenPOSTIsCalledWithoutRequiredFiledThenAnErrorisReturned() throws Exception{
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenPATCHIsCallendToIncrementDiscountThenOkStatusIsReturned() throws Exception{
